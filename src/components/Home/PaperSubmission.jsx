      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-8 md:space-y-12">
          ...
          >
            ...
            <div className="mt-8">
              <button className="w-full md:w-auto bg-purple-600 hover:bg-purple-700 text-white font-semibold py-3 px-8 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 border-2 border-black">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            ...
            >
              ...
              <div className="space-y-4 text-gray-700 text-sm md:text-base leading-relaxed">
                ...
                <div className="mt-6">
                  ...
                  <button className="w-full bg-pink-600 hover:bg-pink-700 text-white font-semibold py-3 px-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 border-2 border-black flex items-center justify-center gap-2">
            ...
            >
              ...
              <div className="mt-6">
                <button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-8 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 border-2 border-black">
                  Submit Via Microsoft CMT
                </button>
              </div>
            </Card>
